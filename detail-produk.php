...
error_reporting(0);
include 'db.php';
$kontak = mysqli_query($conn, "SELECT admin_telp,admin_instagram, admin_email, admin_address FROM tb_admin WHERE admin_id = 1");
...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="index.php">Lionel Fruitspop Hampers</a></h1>
			<ul>
	...
	<div class="footer">
		<div class="container">
            ...
            <h4>instagram</h4>
			<p><?php echo $a->admin_instagram ?></p>
